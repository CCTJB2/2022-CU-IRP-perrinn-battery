within CU_IRP_perrinn_battery.Electrical.Batteries.SoC_OCV;
...
equation
  ...
  connect(m.y, Power.power) annotation (Line(points={{-1,20},{2,20},{2,46},{8,
          46}},   color={0,0,127}));
  ...
  connect(a.y, multiSum.u[1]) annotation (Line(points={{43,80},{70,80},{70,5.25},
