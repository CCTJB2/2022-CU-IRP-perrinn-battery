...
model EP_16Ah8_2RC_OCV_4PartEq "Electric Power 16.8Ah NCM Pouch"
  ...
  Modelica.Blocks.Sources.Constant manaul_set(k=16.8)
                                                   annotation (Placement(
        transformation(
        extent={{10,10},{-10,-10}},
        rotation=180,
...
equation
  ...
  connect(SoC_out, columb_Counting.SoC) annotation (Line(points={{70,80},{42,80},
  ...
  connect(eP_16Ah8_NMC_4PartEq.s, columb_Counting.SoC) annotation (Line(points=
          {{-72,10},{-88,10},{-88,99},{65,99}}, color={0,0,127}));
