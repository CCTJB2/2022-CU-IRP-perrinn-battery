...
model ECM_2RC_EP_16Ah8 "Electric Power 16Ah NCM Pouch"
  ...
  Modelica.Blocks.Sources.Constant Ah_design(k=16.8) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={110,90})));
...
equation
  ...
  connect(columb_Counting.DoD, DoD_OCV.u) annotation (Line(points={{75,99},{-90,
          99},{-90,10},{-82,10}},      color={0,0,127}));
