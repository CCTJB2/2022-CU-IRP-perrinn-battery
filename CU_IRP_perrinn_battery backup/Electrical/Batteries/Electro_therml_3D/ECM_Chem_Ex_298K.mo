...
model ECM_Chem_Ex_298K
  ...
  Modelica.Electrical.Spice3.Basic.C_Capacitor Cel_S(C=88698.08) annotation (
      Placement(transformation(
        ...
        rotation=0,
        origin={110,10})));
  Modelica.Electrical.Spice3.Basic.C_Capacitor Cdl_A(C=737.36e10)
                                                               annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={50,10})));
  Modelica.Electrical.Spice3.Basic.C_Capacitor Cdl_C(C=230.27e10)
                                                               annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
